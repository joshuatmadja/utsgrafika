...
public:
	LineDrawer();
	// Set Clipping Window
	// P1 : Up-Left Point of the  Clipping Window
	// P2 : Down-Right Point of the Clipping Window
	void setView(Point P1, Point P2);
	// Draw line into screen with bresenham algorithm
	// P1 : Starting Point
	// P2 : Ending Point
	// C : Border Color
...
extern LineDrawer linedrawer; //Variable Global
